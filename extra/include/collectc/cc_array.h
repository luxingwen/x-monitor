...
enum cc_stat cc_array_zip_iter_replace(CC_ArrayZipIter *iter, void *e1, void *e2, void **out1,
                                       void **out2);
...
#define CC_ARRAY_FOREACH_ZIP(val1, val2, array1, array2, body)                            \
    {                                                                                     \
        CC_ArrayZipIter cc_array_zip_iter_ea08d3e52f25883b;                               \
        cc_array_zip_iter_init(&cc_array_zip_iter_ea08d3e52f25883b, array1, array2);      \
        void *val1;                                                                       \
        void *val2;                                                                       \
        while (cc_array_zip_iter_next(&cc_array_zip_iter_ea08d3e52f25883b3, &val1, &val2) \
               != CC_ITER_END)                                                            \
            body                                                                          \
    }
