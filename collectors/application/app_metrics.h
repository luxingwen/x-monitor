...
extern const char *__app_metric_sock_tcp_help;
extern const char *__app_metric_sock_udp_help;
extern const char *__app_metric_sock_unix_help;
...
struct app_metrics {
    ...
    prom_gauge_t *metric_sock_tcp;
    prom_gauge_t *metric_sock_udp;
    prom_gauge_t *metric_sock_unix;
