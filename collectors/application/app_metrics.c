...
const char *__app_metric_minflt_help = "The number of minor faults the app has "
                                       "made which have not required "
                                       "loading a memory page from disk.";
const char *__app_metric_vm_cminflt_help = "The number of minor faults that "
                                           "the app's waited-for children have "
                                           "made.";
const char *__app_metric_majflt_help = "The number of major faults the app has "
                                       "made which have required loading a "
                                       "memory page from disk.";
const char *__app_metric_vm_cmajflt_help = "The number of major faults that "
                                           "the app's waited-for children have "
                                           "made.";
const char *__app_metric_cpu_utime_help = "The number of jiffies the app has "
                                          "been scheduled in user mode.";
const char *__app_metric_cpu_stime_help = "The number of jiffies the app has "
                                          "been scheduled in kernel mode.";
const char *__app_metric_cpu_cutime_help = "The number of jiffies the app's "
                                           "waited-for children have been "
                                           "scheduled in user mode.";
const char *__app_metric_cpu_cstime_help = "The number of jiffies the app's "
                                           "waited-for children have been "
                                           "scheduled in kernel mode.";
const char *__app_metric_cpu_total_jiffies_help = "The number of cpu jiffies "
                                                  "the app has been scheduled";
const char *__app_metric_num_threads_help = "The number of threads the app has";
const char *__app_metric_vmsize_kilobytes_help = "The number of kilobytes of "
                                                 "virtual memory";
...
const char *__app_metric_mem_rss_anon_kilobytes_help = "The number of "
                                                       "kilobytes of resident "
                                                       "anonymous memory";
const char *__app_metric_mem_rss_file_kilobytes_help = "The number of "
                                                       "kilobytes of resident "
                                                       "file mappings";
...
const char *__app_metric_mem_vmswap_kilobytes_help = "The number of kilobytes "
                                                     "of Swapped-out virtual "
                                                     "memory size by anonymous "
                                                     "private pages";
...
const char *__app_metric_mem_pss_anon_kilobytes_help =
    "The number of kilobytes of Proportional Set memory size of anonymous "
    "private pages";
...
const char *__app_metric_mem_uss_kilobytes_help =
    "The number of kilobytes of Unique Set memory size, represents the private "
    "memory of a "
...
const char *__app_metric_io_logical_bytes_read_help =
    ...
    "This is "
    "simply the sum of bytes which this process passed to read(2) and similar "
    "system calls";
const char *__app_metric_io_logical_bytes_written_help = "The number of bytes "
                                                         "which this task has "
                                                         "caused, or shall "
                                                         "cause to be written "
                                                         "to disk";
const char *__app_metric_io_read_calls_help = "Attempt to count the number of "
                                              "read I/O operations—that is, "
                                              "system calls "
...
const char *__app_metric_io_storage_bytes_read_help =
    ...
    "to be "
    "fetched from the storage layer.  This is accurate for block-backed "
    "filesystems.";
...
const char *__app_metric_io_cancelled_write_bytes_help =
    "this field represents the number of bytes which this process caused to "
    "not "
    "happen, by truncating pagecache.";
const char *__app_metric_open_fds_help = "The number of open file descriptors";
const char *__app_metric_sock_fds_help = "Statistics of socket type, status "
                                         "and quantity";
const char *__app_metric_max_oom_score_help =
    ...
    "selecting a process for the OOM-killer.  A higher score means that the "
...
const char *__app_metric_nvcsw_help = "The number of voluntary context "
                                      "switches";
const char *__app_metric_nivcsw_help = "The number of involuntary context "
                                       "switches";