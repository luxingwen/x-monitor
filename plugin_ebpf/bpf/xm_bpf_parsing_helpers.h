...
static __always_inline __u8 __parse_ip4hdr(struct hdr_cursor *nh,
                                           void              *data_end,
                                           struct iphdr     **iphdr) {
...
static __always_inline __u8 __parse_ip6hdr(struct hdr_cursor *nh,
                                           void              *data_end,
...
// 解析包头得到ethertype
static __always_inline bool __parse_eth(struct ethhdr *eth, void *data_end,
                                        __u16 *eth_type) {
    __u64 offset;
