...
- node_sockstat_TCP_mem
  ...
  说明：socket buffer usage (unit unknown. Measured with scp, when the speed is 4803.9kB/s: its value = 11, the corresponding 22 port in netstat -ant Recv-Q = 0, Send-Q ≈400)，KiB. 等待关闭的TCP连接数
...
- node_sockstat_UDP_mem
  ...
  说明：IPv4 UDP Sockets Memory, KiB
