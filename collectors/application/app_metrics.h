...
extern const char *__app_metric_rss_anon_help;
extern const char *__app_metric_rss_file_help;
extern const char *__app_metric_rss_shmem_help;
extern const char *__app_metric_vmswap_help;
extern const char *__app_metric_pss_help;
extern const char *__app_metric_pss_anon_help;
extern const char *__app_metric_pss_file_help;
extern const char *__app_metric_pss_shmem_help;
...
struct app_metrics {
    ...
    prom_gauge_t *metric_rss_anon;
    prom_gauge_t *metric_rss_file;
    prom_gauge_t *metric_rss_shmem;
    prom_gauge_t *metric_vmswap;
    prom_gauge_t *metric_pss;
    prom_gauge_t *metric_pss_anon;
    prom_gauge_t *metric_pss_file;
    prom_gauge_t *metric_pss_shmem;
