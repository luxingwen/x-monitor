...
//go:generate env GOPACKAGE=bpfmodule bpf2go -cc clang -cflags "-g -O2 -Wall -Werror -Wno-unused-function -D__TARGET_ARCH_x86 -DOUTPUT_SKB" -type xm_blk_num -type xm_nfs_oplat_stat XMNfs ../../../bpf/xm_nfs.bpf.c -- -I../../../ -I../../../bpf/.output -I../../../../extra/include
//go:generate env GOPACKAGE=bpfmodule bpf2go -cc clang -cflags "-g -O2 -Wall -Wno-unused-function -D__TARGET_ARCH_x86 -DOUTPUT_SKB" -type xm_profile_sample -type xm_profile_sample_data -type xm_prog_filter_args -type xm_prog_filter_target_scope_type -type xm_profile_fde_table_row -type xm_profile_fde_table_info -type xm_profile_proc_maps_module -type xm_profile_pid_maps -type xm_profile_module_fde_tables -type xm_ehframe_user_stack XMProfile ../../../bpf/xm_profile.bpf.c -- -I../../../ -I../../../bpf/.output -I../../../../extra/include
