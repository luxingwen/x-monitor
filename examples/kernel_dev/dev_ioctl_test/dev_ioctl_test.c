...
#define CW_DEV_DRV_NAME "cw_ioctl_drv"
#define CW_DEV_CLS_NAME "cw_ioctl_cls"
#define CW_CRT_DEV_FMT "cw_ioctl_test_dev%d"
...
// 设备创建上下文
static struct module_cdev_crt_ctx __cw_ioctl_dev_crt_ctx;
...
static int32_t __init cw_ioctl_test_init(void)
{
	...
	__cw_ioctl_dev_crt_ctx.cdev_driver_name = CW_DEV_DRV_NAME;
	__cw_ioctl_dev_crt_ctx.fops = &__ioctl_dev_fops;
	__cw_ioctl_dev_crt_ctx.owner = THIS_MODULE;
	__cw_ioctl_dev_crt_ctx.cdev_cls_name = CW_DEV_CLS_NAME;
	__cw_ioctl_dev_crt_ctx.cdev_name_fmt = CW_CRT_DEV_FMT;
