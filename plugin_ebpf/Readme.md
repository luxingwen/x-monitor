...
| x-monitor.eBPF.BioLatency | 1：按设备号进行分类统计<br />2：设备的随机读取的比例<br />3：设备顺序读取的比例<br />4：设备读取的次数<br />5：设备读取的字节kB数<br />6：request从insert到complete执行的耗时分布，2的指数分布<br />7：request从issue到complete执行的耗时分布，2的指数分布 | 待实现                                           |
