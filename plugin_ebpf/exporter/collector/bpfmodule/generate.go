...
//go:generate env GOPACKAGE=bpfmodule bpf2go -cc clang -cflags "-g -O2 -Wall -Werror -Wno-unused-function -D__TARGET_ARCH_x86 -DOUTPUT_SKB" -type xm_profile_sample -type xm_prog_filter_args -type xm_prog_filter_target_scope_type XMProfile ../../../bpf/xm_profile.bpf.c -- -I../../../ -I../../../bpf/.output -I../../../../extra/include
