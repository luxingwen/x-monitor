 ...
 * @Last Modified time: 2023-03-25 15:01:40
 */
...
//go:generate env GOPACKAGE=bpfmodule bpf2go -cc clang -cflags "-g -O2 -Wall -Werror -Wno-unused-function -D__TARGET_ARCH_x86 -DOUTPUT_SKB" XMProcessVM ../../../bpf/xm_process_vm.bpf.c -- -I../../../ -I../../../bpf/.output -I../../../../extra/include/bpf
