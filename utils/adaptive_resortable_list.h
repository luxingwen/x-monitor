...
// create a new ARL
extern ARL_BASE *arl_create(const char *name,
...
extern ARL_ENTRY *arl_expect_custom(ARL_BASE *base, const char *keyword,
                                    void (*processor)(const char *name, uint32_t hash,
...
extern int32_t arl_find_or_create_and_relink(ARL_BASE *base, const char *s, const char *value);
...
// extern void arl_callback_str2kernel_uint_t(const char *name, uint32_t hash, const char *value,
//                                            void *dst);
...
static inline int32_t arl_check(ARL_BASE *base, const char *keyword, const char *value) {
