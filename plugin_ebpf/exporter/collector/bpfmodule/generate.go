...
//go:generate env GOPACKAGE=bpfmodule bpf2go -cc clang -cflags "-g -O2 -Wall -Wno-unused-function -D__TARGET_ARCH_x86 -DOUTPUT_SKB" -type xm_profile_sample -type xm_profile_sample_data -type xm_prog_filter_args -type xm_prog_filter_target_scope_type -type xm_profile_fde_row -type xm_profile_fde_table -type xm_proc_maps_module -type xm_pid_maps -type xm_profile_module_fde_tables XMProfile ../../../bpf/xm_profile.bpf.c -- -I../../../ -I../../../bpf/.output -I../../../../extra/include
